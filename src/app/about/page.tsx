        ...
        <div className="flex md:gap-x-10 gap-y-10 items-center md:my-28 my-16 flex-col md:flex-row">
            ...
            <div className="w-full text-center md:text-left">
                ...
                <p className="mt-3">
                    ...
                    , I have a love for diverse interests. I enjoy immersing myself in the world of
                    gaming, particularly indulging in Call of Duty Mobile. Connecting with friends
                    and family is another source of happiness for me. Oh, and I can&apos;t forget to
    ...
    return (
        <div className="lg:w-[60%] text-stone-700 dark:text-stone-400">
            ...
            <div className="mt-6">
                ...
                <br />
                <p>
                    My journey in software development is driven by a passion for creating
                    innovative, user-centered solutions. I approach every project with meticulous
                    attention to detail, overcoming challenges with thoughtful problem-solving to
                    deliver seamless experiences that align with both user expectations and business
                    objectives.
                </p>
                <br />
                <br />
